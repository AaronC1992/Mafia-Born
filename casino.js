...
function bjResolve() {
  ...
  html += `<div style="text-align:center;display:flex;justify-content:center;gap:10px;">
    <button onclick="startBlackjack()" style="background:#7a8a5a;color:white;padding:10px 24px;border:1px solid #c0a062;border-radius:8px;cursor:pointer;font-weight:bold;">Play Again</button>
    <button onclick="showCasino()" style="background:#6a5a3a;color:white;padding:10px 20px;border:1px solid #c0a062;border-radius:8px;cursor:pointer;">Back to Games</button>
  </div>`;
  html += '</div>';
  gameArea.innerHTML = html;
}
    ...
    <div style="background: linear-gradient(135deg, rgba(100,0,0,0.6), rgba(40,0,0,0.8)); padding: 25px; border-radius: 15px; border: 2px solid #8b3a3a;">
      ...
      <div style="margin:15px 0;">
        ...
        <div style="display:flex;justify-content:center;gap:8px;flex-wrap:wrap;">
          <button onclick="rouletteAddBet('red')" style="background:#7a2a2a;color:white;padding:8px 18px;border:1px solid #c0a062;border-radius:6px;cursor:pointer;font-weight:bold;">Red</button>
          <button onclick="rouletteAddBet('black')" style="background:#14120a;color:white;padding:8px 18px;border:1px solid #c0a062;border-radius:6px;cursor:pointer;font-weight:bold;">Black</button>
          <button onclick="rouletteAddBet('odd')" style="background:#7a5a3a;color:white;padding:8px 18px;border:1px solid #c0a062;border-radius:6px;cursor:pointer;font-weight:bold;">Odd</button>
          <button onclick="rouletteAddBet('even')" style="background:#a08850;color:white;padding:8px 18px;border:1px solid #c0a062;border-radius:6px;cursor:pointer;font-weight:bold;">Even</button>
          <button onclick="rouletteAddBet('low')" style="background:#7a8a5a;color:white;padding:8px 18px;border:1px solid #c0a062;border-radius:6px;cursor:pointer;font-weight:bold;">1-18</button>
          <button onclick="rouletteAddBet('high')" style="background:#e67e22;color:white;padding:8px 18px;border:1px solid #c0a062;border-radius:6px;cursor:pointer;font-weight:bold;">19-36</button>
        </div>
      </div>
      ...
      <div style="margin:15px 0;">
        ...
        <div id="roulette-numbers" style="display:flex;flex-wrap:wrap;justify-content:center;gap:4px;max-width:500px;margin:0 auto;">
          <button onclick="rouletteAddBet(0)" style="background:#7a8a5a;color:white;padding:5px 10px;border:1px solid #c0a062;border-radius:4px;cursor:pointer;font-size:0.9em;min-width:36px;">0</button>
          ${Array.from({length:36},(_, i) => {
            const n = i+1;
            const isRed = [1,3,5,7,9,12,14,16,18,19,21,23,25,27,30,32,34,36].includes(n);
            return `<button onclick="rouletteAddBet(${n})" style="background:${isRed ? '#7a2a2a' : '#14120a'};color:white;padding:5px 10px;border:1px solid #c0a062;border-radius:4px;cursor:pointer;font-size:0.9em;min-width:36px;">${n}</button>`;
          }).join('')}
        </div>
      </div>
...
export function rouletteSpin() {
  ...
  html += `<div style="margin-top:15px;display:flex;justify-content:center;gap:10px;">
    <button onclick="startRoulette()" style="background:#7a2a2a;color:white;padding:10px 24px;border:1px solid #c0a062;border-radius:8px;cursor:pointer;font-weight:bold;">Play Again</button>
    <button onclick="showCasino()" style="background:#6a5a3a;color:white;padding:10px 20px;border:1px solid #c0a062;border-radius:8px;cursor:pointer;">Back to Games</button>
  </div>`;
  html += '</div>';
  gameArea.innerHTML = html;
